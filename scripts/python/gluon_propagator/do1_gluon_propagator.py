...
for beta, mu, conf_size, additional_parameters, decomposition_type in itertools.product(*iter_arrays):
    ...
    for job in jobs:
        ...
        try:
            ...
            pass
        output_path = f'/home/clusters/rrcmpi/kudrov/observables_cluster/result/gluon_propagator/{theory_type}/'\
        ...
        bashCommand = f'qsub -q mem16gb -l nodes=1:ppn=8 -v convert={convert},file_precision={file_precision},'\
            ...
            f' -o {log_path}/{job[1]:04}-{job[2]:04}.o -e {log_path}/{job[1]:04}-{job[2]:04}.e ../../bash/gluon_propagator/do_gluon_propagator.sh'
        # print(bashCommand)
