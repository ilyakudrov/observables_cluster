    ...
    for beta in ['/']:\
        ...
        for mu in ['mu0.00', 'mu0.05', 'mu0.35', 'mu0.45']:
            ...
            for job in jobs:
                ...
                log_path = f'/home/clusters/rrcmpi/kudrov/observables_cluster/logs/polaykov_loop/{theory_type}/{conf_type}/{conf_size}/{beta}/{mu}/{monopole}/{smearing}/{job[0]}'
                ...
                output_path = f'/home/clusters/rrcmpi/kudrov/observables_cluster/result/polaykov_loop/{theory_type}/{conf_type}/{conf_size}/{beta}/{mu}/{monopole}/{smearing}/{job[0]}'
                ...
                bashCommand = f'qsub -q long -v conf_format={conf_format},'\
                    ...
                    f' -o {log_path}/{job[1]:04}-{job[2]:04}.o -e {log_path}/{job[1]:04}-{job[2]:04}.e /home/clusters/rrcmpi/kudrov/observables_cluster/scripts/do_polaykov_loop.sh'
                # print(bashCommand)
