    ...
    for beta in ['beta2.4', 'beta2.5', 'beta2.6']:
        ...
        for mu in ['/']:
            ...
            for job in jobs:
                ...
                log_path = f'/home/clusters/rrcmpi/kudrov/observables_cluster/logs/wilson_loop_adjoint/{axis}/{theory_type}/{conf_type}/{conf_size}/{beta}/{mu}/{monopole}/{smearing}/{job[0]}'
