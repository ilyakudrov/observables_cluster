...
additional_parameters = 'steps_8000/copies=1/tol=1e-13'
...
for beta in ['/']:
    ...
    for mu in ['/']:
        ...
        #bites_skip = 0
        #matrix_type = 'su3'
        #conf_path_start = f'/home/clusters/rrcmpi/kudrov/mag_su3/conf_maximized/{theory_type}/{conf_type}/{conf_size}/{beta}/{mu}/{additional_parameters}'
        #conf_path_end = "/"
        #padding = 4
        #conf_name = "conf.SP_gaugefixed_"
