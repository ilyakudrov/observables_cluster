...
for beta, mu, conf_size, decomposition_type_plaket, decomposition_type_wilson, smearing, additional_parameters in itertools.product(*iter_arrays):
    ...
    for job in jobs:
        ...
        output_path = f'/home/clusters/rrcmpi/kudrov/observables_cluster/result/flux_tube_schwinger/{theory_type}/{conf_type}/{conf_size}/{beta}/{mu}/{decomposition_type_plaket}-{decomposition_type_wilson}'\
            f'/{smearing}/{job[0]}'
