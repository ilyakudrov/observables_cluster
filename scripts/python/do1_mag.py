    ...
    #for mu in ['/']:
        ...
        for job in jobs:
            ...
            try:
                ...
                pass
            output_path = f'/home/clusters/rrcmpi/kudrov/observables_cluster/result/mag/{theory_type}/{conf_type}/{conf_size}/{beta}/{mu}/'\
                f'T_step={T_step}/T_final={T_final}/OR_steps={OR_steps}/{job[0]}'
            # qsub -q mem8gb -l nodes=1:ppn=4
            bashCommand = f'qsub -q long -v conf_path_start={conf_path_start1},conf_path_end={conf_path_end},padding={padding},matrix_type={matrix_type},conf_format={conf_format},bites_skip={bites_skip},'\
                f'T_step={T_step},T_init={T_init},T_final={T_final},OR_steps={OR_steps},thermalization_steps={thermalization_steps},output_path={output_path},'\
