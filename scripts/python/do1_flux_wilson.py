...
for beta, mu, conf_size, decomposition_type_plaket, decomposition_type_wilson, smearing, additional_parameters in itertools.product(*iter_arrays):
    ...
    conf_path_start = f'/home/clusters/rrcmpi/kudrov/smearing/{theory_type}/{conf_type}/{conf_size}/{beta}/{mu}/{decomposition_type_wilson}/{smearing}/{additional_parameters}'
    conf_name = 'smeared_'
    conf_path_end = '/'
    conf_format = 'double'
    padding = 4
