...
for beta in ['beta2.4']:
    ...
    for mu in ['/']:
        ...
        if wilson_type == 'original':
            ...
            bites_skip_wilson = data['bites_skip']
            ...
            conf_path_start_wilson = f'/home/clusters/rrcmpi/kudrov/decomposition/confs_decomposed/'\
                f'monopole/su2/{conf_type}/{conf_size}/{beta}/{mu}/T_step={T_step}/T_final={T_final}/OR_steps={OR_steps}'
            conf_path_end_wilson = '/'
            padding_wilson = 4
            conf_name_wilson = 'conf_{wilson_type}_'
        ...
        if plaket_type == 'original':
            ...
            bites_skip_plaket = data['bites_skip']
            ...
            padding_plaket = 4
            conf_name_plaket = 'conf_{wilson_type}_'
        ...
        for job in jobs:
            ...
            bashCommand = f'qsub -q long -v conf_path_start_plaket={conf_path_start_plaket1},conf_path_end_plaket={conf_path_end_plaket},'\
                f'conf_path_end_plaket={conf_path_end_plaket},conf_format_plaket={conf_format_plaket},bites_skip_plaket={bites_skip_plaket},'\
                f'conf_path_start_plaket={conf_path_start_wilson1},conf_path_end_wilson={conf_path_end_wilson},'\
                f'conf_path_end_wilson={conf_path_end_wilson},conf_format_wilson={conf_format_wilson},bites_skip_wilson={bites_skip_wilson},'\
                ...
                f'path_wilson={path_conf_wilson_loop},path_flux={path_conf_flux_tube},'\
