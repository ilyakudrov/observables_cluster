...
#additional_parameters_arr = ['steps_50/copies=2', 'steps_100/copies=1', 'steps_100/copies=2']
#additional_parameters_arr = ['steps_0/copies=1', 'steps_2/copies=1', 'steps_10/copies=1']
...
for beta, mu, conf_size, additional_parameters in itertools.product(*iter_arrays):
    ...
    for job in jobs:
        ...
        path_decomp = f'/home/clusters/rrcmpi/kudrov/decomposition/confs_decomposed/monopole/{theory_type}/{conf_type}/{conf_size}/{beta}/{mu}/{additional_parameters}/{job[0]}'
        ...
        bashCommand = f'qsub -q kepler -l nodes=1:ppn=8 -v conf_path_start={conf_path_start1},conf_path_end={conf_path_end},padding={padding},conf_format={conf_format},bytes_skip={bytes_skip},'\
            f'output_conf_path={output_conf_path},conf_name={conf_name},calculate_absent={calculate_absent},path_decomp={path_decomp},gauge_copies={gauge_copies},'\
