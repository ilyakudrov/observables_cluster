...
for conf_type in ['original']:
    ...
    # for beta in ['beta6.0']:
        ...
        #for mu in ['/']:
            ...
            f = open(
                f'/home/clusters/rrcmpi/kudrov/conf/{theory_type}/{conf_type}/{conf_size}/{beta}/{mu}/parameters_{conf_type}.json')
            data = json.load(f)
            ...
            for job in jobs:
                ...
                log_path = f'/home/clusters/rrcmpi/kudrov/observables_cluster/logs/chiral_condensate/{theory_type}/{conf_type}/{conf_size}/{beta}/{mu}/{conf_type}/{additional_parameters}/{job[0]}'
                ...
                output_path = f'/home/clusters/rrcmpi/kudrov/observables_cluster/result/chiral_condensate/{theory_type}/{conf_type}/{conf_size}/{beta}/{mu}/{conf_type}/{additional_parameters}/{job[0]}'
