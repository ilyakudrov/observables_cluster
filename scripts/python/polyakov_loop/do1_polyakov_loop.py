...
#                           "photon", "offdiagonal", "abelian", "original"]
...
for beta, mu, conf_size, additional_parameters, decomposition_type, smearing in itertools.product(*iter_arrays):
    ...
    for job in jobs:
        ...
        log_path = f'/home/clusters/rrcmpi/kudrov/observables_cluster/logs/wilson_loop/{theory_type}/{conf_type}/{conf_size}/{beta}/{mu}/'\
        ...
        bashCommand = f'qsub -q long -v conf_format={conf_format},'\
            f'bytes_skip={bytes_skip},matrix_type={matrix_type},'\
