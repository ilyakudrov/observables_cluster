...
beta_arr = ['/']
# beta_arr = ['beta2.4']
mu_arr = ['mu0.00', 'mu0.05', 'mu0.25', 'mu0.35', 'mu0.45']
conf_size_arr = ['nt16']
...
for beta, mu, conf_size in itertools.product(*iter_arrays):
    ...
    for job in jobs:
        ...
        log_path = f'/home/clusters/rrcmpi/kudrov/observables_cluster/logs/flux_tube_wilson_tr/{theory_type}/{conf_type}/{conf_size}/{beta}/{mu}/{monopole1}-{monopole2}/{job[0]}'
