...
for beta, mu, conf_size, additional_parameters in itertools.product(*iter_arrays):
    ...
    for job in jobs:
        log_path = f'/home/clusters/rrcmpi/kudrov/observables_cluster/logs/Landau_SU3/{theory_type}/{conf_type}/{conf_size}/{beta}/{mu}/'\
        ...
        try:
            ...
            pass
        output_path_functional = f'/home/clusters/rrcmpi/kudrov/observables_cluster/result/Landau_SU3/functional/{theory_type}/{conf_type}/{conf_size}/{beta}/{mu}/'\
            f'{additional_parameters}/{job[0]}'
