...
def queue_job(df1, spec_additional_path, bin_test, program_name):
    df = df1.reset_index()
    ...
    log_path = f'/home/clusters/rrcmpi/kudrov/observables_cluster/logs/eos_energy_average/common_{program_name}'
    try:
    ...
    command_parameters = f'base_paths={base_paths},lattice_sizes={lattice_sizes},boundaries={boundaries},velocities={velocities},betas={betas},add_parameters={add_parameters},program_name={program_name}'
...
job_number = 1000
#data_summary_path = '/home/clusters/rrcmpi/kudrov/observables/result/eos_rotation_imaginary/data_polyakov_summary.csv'
