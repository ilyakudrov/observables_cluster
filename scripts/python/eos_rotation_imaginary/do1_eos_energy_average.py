...
#lattice_size_arr = ['4x24x97sq']
#lattice_size_arr = ['5x30x181sq', '30x30x181sq', '5x30x81sq', '30x30x81sq']
...
for lattice_size, boundary in itertools.product(*iter_arrays):
    ...
    for velocity in velocity_dirs:
        ...
        for beta in beta_dirs:
            log_path = f'/home/clusters/rrcmpi/kudrov/observables_cluster/logs/eos_energy_average/distribution/{lattice_size}/{boundary}/{velocity}/{beta}'
            try:
