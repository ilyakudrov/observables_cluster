...
output_path_electric_long_l="${output_path}/longitudinal/electric_l_`printf %04d $i`"
output_path_electric_long_tr="${output_path}/longitudinal/electric_tr_`printf %04d $i`"
output_path_magnetic_long_l="${output_path}/longitudinal/magnetic_l_`printf %04d $i`"
output_path_magnetic_long_tr="${output_path}/longitudinal/magnetic_tr_`printf %04d $i`"
output_path_electric_trans_l="${output_path}/transversal/electric_l_`printf %04d $i`"
output_path_electric_trans_tr="${output_path}/transversal/electric_tr_`printf %04d $i`"
...
parameters="--conf_format_plaket $conf_format_plaket --conf_format_wilson ${conf_format_wilson} --conf_path_plaket $conf_path_plaket\
   ...
   --HYP_alpha1 ${HYP_alpha1} --HYP_alpha2 ${HYP_alpha2} --HYP_alpha3 ${HYP_alpha3} --APE_alpha ${APE_alpha} --APE_steps ${APE_steps} --HYP_steps ${HYP_steps}\
