...
parameters="--conf_format ${conf_format} --path_conf $path_conf --bytes_skip ${bytes_skip} \
    ...
    --T_step ${T_step} --T_init ${T_init} --T_final ${T_final} --OR_steps ${OR_steps} --thermalization_steps ${thermalization_steps} --file_precision ${file_precision}\
...
/home/clusters/rrcmpi/kudrov/general_code/apps/mag_su2/mag_fixation_${arch} $parameters
