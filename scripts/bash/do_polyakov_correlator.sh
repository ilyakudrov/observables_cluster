...
parameters="--conf_format ${conf_format} --path_conf ${conf_path1} --bytes_skip ${bytes_skip} --file_precision ${file_precision}\
    --x_size ${L_spat} --y_size ${L_spat} --z_size ${L_spat} --t_size ${L_time} --D_max ${D_max} --correlator_type ${correlator_type}\
